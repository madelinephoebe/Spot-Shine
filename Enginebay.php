...
<body>
  ...
  <section id="engineBayCleaningContent">
  <h2>Engine Bay Cleaning for a Pristine Look</h2><br>

  <p style="text-align: left; margin-left: 20px; margin-right: 20px;">
    <strong>Introduction:</strong> Cleaning your engine bay not only enhances the overall appearance of your vehicle but also helps in identifying potential issues. Follow these steps to achieve a spotless engine bay and keep your car running smoothly.
    <br><br>
    To learn more about engine bay cleaning, please watch the video below:
  </p><br>
      <form>
        <div class="border-container3" style="background-color: white;" alt="properway">
          <div id="player"></div>
          <script>
            var videoId = '60Y_TgP2uvQ';
    ...
    <p style="text-align: center; margin-left: 0px; margin-right: 20px;">
      ...
      Engine degreaser<br> All-purpose cleaner<br> Soft brushes and detailing brushes<br> Microfiber towels<br> Plastic
      or rubber protectant<br><br></p>
 <strong>Vacuuming:</strong> Start by thoroughly vacuuming the interior, including carpets, seats, and the trunk. Use appropriate attachments to reach tight spaces.<br>
